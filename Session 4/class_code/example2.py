...
@mcp.tool()
async def draw_tool(x1: int, y1: int, x2: int, y2: int, draw_tool: str="Rectangle") -> dict:
    """Draw a selected tool provided in the arguments in Paint from (x1,y1) to (x2,y2)"""
    global paint_app
    tool_loc = {"Rectangle": (530, 82),
                "Diamond": (488, 110),
                "Arrow": (468, 140),
                "Heart": (468, 150)}
    try:
        ...
        paint_window.wait('visible ready', timeout=20)
        ...
        if draw_tool in tool_loc:
            tool_x, tool_y = tool_loc[draw_tool]
        paint_window.click_input(coords=(tool_x, tool_y ))
        time.sleep(0.2)
        ...
        paint_window.press_mouse_input(coords=(x1+primary_width, y1))
        time.sleep(0.5)
        paint_window.move_mouse_input(coords=(x2+primary_width, y2))
        time.sleep(0.5)
        paint_window.release_mouse_input(coords=(x2+primary_width, y2))
        time.sleep(2.0)
        ...
        if draw_tool=="Heart":
            ...
            paint_window.click_input(coords=(1020, 92))
...
async def add_text_in_paint(text: str) -> dict:
    ...
    try:
        ...
        paint_window.click_input(coords=(628, 92))
        time.sleep(0.5)
        ...
        paint_window.click_input(coords=(810, 533))
        time.sleep(0.5)
